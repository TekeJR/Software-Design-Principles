...
class Base_Array
{
    public:
        ...
        /**
         * Retreives current size of the array. 
         * 
         ...
         */
        virtual Base_Array slice(size_t begin) const;
         ...
         * @return          A new Array object
         */
        virtual Base_Array slice(size_t begin, size_t end) const;
